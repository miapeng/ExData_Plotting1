...
globalactive<-as.numeric(powersub$Global_active_power)*0.001 #Re-scale the data to match sample

sub1<-as.numeric(powersub$Sub_metering_1)
sub2<-as.numeric(powersub$Sub_metering_2)
sub3<-as.numeric(powersub$Sub_metering_3)

#Plot4
volt<-as.numeric(powersub$Voltage)
globalreactive<-as.numeric(powersub$Global_reactive_power)*0.001 #Re-scale data to match sample
